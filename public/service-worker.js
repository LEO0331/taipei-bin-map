...
const APP_SHELL = [
  ...
  '/data/public-school-sports-venues/records.json',
  ...
  '/data/certified-bathhouses/summary.json',
  '/data/recycling-analytics/records.json',
  '/data/recycling-analytics/summary.json',
